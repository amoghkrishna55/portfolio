      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center space-y-8">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="text-blue-500">
                ...
                {/* <span
                  className={
                    isVisible ? "inline-block w-[1px] bg-blue-500" : "hidden"
                  }
                >
                  &#9612;
                </span> */}
            ...
            <p className="text-xl text-gray-300 sm:text-2xl">
              A passionate software engineer who loves to build stuff for the
              real world
            </p>
          ...
          <div className="flex items-center justify-center">
            <div className="relative h-64 w-64 overflow-hidden rounded-full sm:h-72 sm:w-72 lg:h-96 lg:w-96"></div>
          </div>
        </div>
      </div>
    </div>
